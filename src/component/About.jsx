				...
				>
					...
					<figure className="relative isolate pt-6 sm:pt-12">
						...
						<blockquote className="text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
							<p>
								I am positive thinker and independent woman. I accept challenges
								and battles of my life. However I constantly setting goals for
								myself. I always choose to unwind to have a peace of mind
							</p>
						</blockquote>
